...
- [](sentiment:pos)[The Palatines](name) would be saved.
- [](sentiment:neg)[The Hessians](name) would be left and not get any help.
- [](sentiment:neg)[Ahmed](name) would be crushed and die
- [](sentiment:neu)[The Saxons](name:the Saxons) and [Frank](name) would survive
- [Jörg](name)[](sentiment:neg) would propably die very soon
- [Jörg](name)[](sentiment:pos) would have a higher probability of surviving
- [The Saxons](name:the Saxons) would be in danger of suffocating due to the lack of oxygen
- [](sentiment:neg)[The five workmen](stakeholder:the five workmen) would all get killed
- /consequence[{"name": "the Palatines"}](name:the Palatines)
- [Nathan](name), who stands on the side track, would survive
- [](sentiment:neg)[Nathan](name) would die from being overrun by the trolley.
- [](sentiment:pos)[The Palatines](name) would all be saved from the approaching trolley and survive.
- /consequence[{"name": "the Palatines"}](name:the Palatines)
- [Inga](name) would die from taking the medication.
- [](sentiment:neu)[The Saxons](name:the Saxons) would be prevented from catching HIV.
- [](sentiment:neg)[The Saxons](name:the Saxons) would get infected with HIV.
- [Inga](name)[](sentiment:neu) would not be poisened by her doctor and survive.
- /consequence[{"name": "Inga"}](name:Inga)
- [](sentiment:neg)[Amelie](name) would suffer pain from being tortured and eventually die.
- [](sentiment:pos)[Tom](name) and the [eight](quantity) children would survive and come free.
- /consequence[{"name": "the Rhinelanders"}](name:the Rhinelanders)
- [](sentiment:neg)[The Saxons](name:the Saxons) would get killed nevertheless.
- [](sentiment:neg)[The Saxons](name:the Saxons) would get killed
- [](sentiment:neg)[Patrick](name) is also going to be killed.
- [](sentiment:neg)[The Rhinelanders](name:the Rhinelanders) would die as well.
- [](sentiment:neg)[Amelie](name) would suffocate and die a bit earlier than expected
...
- [](sentiment:neu)[Amelie](name) could live a few days longer than expected.
- [Samuel](name) would not get any money from his life insurance that he can give to his family.
- [](sentiment:neu)[Greta](name) would also not receive any money from the life insurance.
- [](sentiment:neg)[Amelie](name) would die from being overheated by the furnace
- [](sentiment:neg)[The Swabians](name:the Swabians) would suffer from the uncomfortable heat produced by the furnace but they would survive.
- [](sentiment:neg)[Jane](name) would suffer greatly from the loss of her baby.
- [](sentiment:neg)[The Swabians](name:the Swabians) would get killed by the soldiers.
- [Amelie](name) would survive as she is less than 2 years old.
- [](sentiment:neg)[Jane](name) would also be killed by the soldiers.
- [](sentiment:neg)[Jörg](name) would get crushed by the emergency access hatch and die.
- [](sentiment:neu)[The Palatines](name) would have enough oxygen to survive
- /consequence[{"name": "the Palatines"}](name:the Palatines)
- [](sentiment:neu)[Mark](name) would also survive
- [](sentiment:neu)[Jörg](name) would survive because in the lower part of the ship there would be enough oxygen for him.
- [](sentiment:neg)[The Palatines](name) would die because the oxygen would not suffice for all of them.
- /consequence[{"name": "the Palatines"}](name:the Palatines)
- [](sentiment:pos)[Mark](name) would suffocate as well
- [](sentiment:neg)[Katharina](name) would be dead as she gets hit by the trolley.
- /consequence[{"name": "Katharina"}](name:Katharina)
- [](sentiment:neu)[The Palatines](name) would survive as the approaching trolley is stopped.
- /consequence[{"name": "the Palatines"}](name:the Palatines)
- [](sentiment:neg)[The Palatines](name) would get overrun by the trolley and die.
- /consequence[{"name": "the Palatines"}](name:the Palatines)
- [Katharina](name)[](sentiment:neu)Katharina would not get pushed on the tracks and therefore survive.
- /consequence[{"name": "Katharina"}](name:Katharina)
- [](sentiment:neg)[Herbert](name) would die from his injuries
- [](sentiment:neu)[Zoe](name) would survive
- [](sentiment:neu)[Heather](name) would survive too
- [](sentiment:neu)[Herbert](name) would survive due to taking the medicine
- [](sentiment:neg)[Heather](name) and the others would die from having not enough oxygen
- [](sentiment:neg)[The Rhinelanders](name:the Rhinelanders) would drown in the ocean.
- [](sentiment:neu)[The Hessians](name) would propably survive in the lifeboat.
- /consequence[{"name": "the Hessians"}](name:the Hessians)
- [Doug](name)[](sentiment:neu)Doug would also survive
- [](sentiment:neu)[The Rhinelanders](name:the Rhinelanders) could enter the lifeboat and would eventually survive.
- [](sentiment:neg)[Doug](name) would also get in danger of drowning in the ocean as the overloaded boat is sinking.
- [](sentiment:neg)[The Hessians](name) would get in danger as the boat is overloaded and might sink.
- /consequence[{"name": "the Hessians"}](name:the Hessians)
- [](sentiment:neg)[Frank](name) would die as the fumes will enter the room and [kill him](deed).
- [](sentiment:neu)[The Hessians](name) would live
- /consequence[{"name": "the Hessians"}](name:the Hessians)
- [](sentiment:neg)[The Hessians](name) would die from the fumes entering their room.
- /consequence[{"name": "the Hessians"}](name:the Hessians)
- [](sentiment:neu)[Frank](name) would survive
- [](sentiment:neg)[Carla](name) would be hung and die
- [](sentiment:neg)[Inga](name) would have to live with the fact that she has killed her own child which would make her suffer greatly
- [](sentiment:pos)[Viola](name) would not get killed by the sadistic guard
- /consequence[{"name": "Viola"}](name:Viola)
- [](sentiment:neg)[Carla](name) would die anyway
- [](sentiment:neg)[Viola](name) would then get killed by the guard.
- /consequence[{"name": "Viola"}](name:Viola)
- [](sentiment:pos)[Inga](name) could propably be saved from dying of her injuries
- [Michelle](name) would most definitely bleed to death if she does not receive medical care immediately
- [](sentiment:pos)[Roswitha](name) would most definitely die
- [](sentiment:pos)[Michelle](name) could possibly be saved from bleeding to death
- [Mark](name) would very likely get fired for revealing information from a staff email.
- [](sentiment:neu)[Viola](name)'s affair would be discovered by her husband and she'd propably get in big trouble
- /consequence[{"name": "Viola"}](name:Viola)
- [Zoe](name) would know about his wife's affair.
- [](sentiment:neg)[Carla](name) would get killed by the explosion.
- [](sentiment:neg)[The Rhinelanders](name:the Rhinelanders) could escape from the cave they are currently trapped in
- [](sentiment:neu)[Carla](name) would eventually survive because her head is out of the cave.
- [](sentiment:neg)[The Rhinelanders](name:the Rhinelanders) would all drown in the cave.
- [](sentiment:pos)[Werner](name) would definitely be saved from drowning
- [Carla](name) would most definitely die from drowning because she already is really struggling to hold her head above water
- [](sentiment:neg)[Werner](name) would die with a chance of [50](quantity)%
- [](sentiment:pos)[Carla](name) would be rescued and survive
...
- /consequence[{"name": "Patrick"}](name:Patrick)
- [Esther](name) is considering claiming the bag hers and if she does so she will get prosecuted
- [](sentiment:pos)[Patrick](name) would remain free as his mother protects him
- [](sentiment:pos)[Carl](name) would remain free as well
- [](sentiment:neg)[The Saxons](name:the Saxons) would suffer great pain due to the torture
...
- [](sentiment:pos)Lars would have the same chance of surviving as the other passengers
- /consequence[{"name": "Lars"}](name:Lars)
...
- /decider[{"name": "Doug"}](name:Doug)
- /decider[{"name": "Carrie"}](name:Carrie)
...
- She could also just [do nothing](deed) and let the fumes go to the room with [four people](stakeholder)[four](quantity) people.
